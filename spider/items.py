...
class SpiderItem(scrapy.Item):
    ...
    item_id = scrapy.Field(input_processor=ustrip, output_processor=TakeFirst())
    name = scrapy.Field(input_processor=ustrip, output_processor=TakeFirst())
    image_id = scrapy.Field(input_processor=extract_image_id, output_processor=TakeFirst())
    rating = scrapy.Field(input_processor=ustrip, output_processor=TakeFirst())
